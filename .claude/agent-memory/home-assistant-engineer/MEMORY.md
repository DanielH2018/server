...
- [2026-08-16c review findings](review-2026-08-16c-findings.md) — the HA-domain don't-re-flag ledger (PR #218): 10 findings fixed and deployed, 1 refuted, 1 deliberately excluded. Moved here 2026-08-29 from the project memory index, where it was injected into every session while only `/ha-review` ever read it.
