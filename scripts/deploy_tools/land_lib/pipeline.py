...
| `classify.classify` | `merge_sha`, `opts.since`, `opts.primary` | `resolved_tags`, `plane`, `self_applied`, `remaining_setup`, `needs_diff`, `pr_paths`, `pr_range`, `declared`, `quiet`, `plane_paths` |
