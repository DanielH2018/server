...
@dataclass
class TickRun:
    """One REAL gated tick, as `deploy_staging_io.record_staging_tick` writes it.
...
def main() -> int:
    ...
    ap.add_argument(
        ...
        "report it as a second section. Written by deploy_staging_io.record_staging_tick; the "
