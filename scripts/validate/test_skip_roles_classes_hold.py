...
Run: uv run pytest scripts/validate/test_skip_roles_classes_hold.py
"""
...
def test_the_two_classes_are_disjoint_and_cover_skip_roles():
    """The rejecting half of the split itself: a name in both sets would satisfy both tests
    above while meaning nothing, and a name in neither would silently stop being skipped."""
