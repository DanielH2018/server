...
This file holds the `wait`-shaped credit and the two tree-wide assertions. The
`cronjob-gate` delegation cases are `test_k8s_autodeploy_cronjob_gate_credit.py`; what counts
