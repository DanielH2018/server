...
def test_daniel_server_is_still_wholly_docker():
    ...
    # and speedtest followed the same day behind the strangler bridge (45 -> 44). The count
    ...
    assert len(containers) == 44
    assert len(filter_by_platform(containers, "docker")) == 44
