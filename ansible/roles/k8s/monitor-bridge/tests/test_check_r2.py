...
def test_r2_month_start_is_utc_first_of_month():
    ...
    assert checks.r2.r2_month_start(now) == datetime(2026, 8, 1, tzinfo=timezone.utc)


def test_r2_classify_splits_the_two_billed_classes():
    a, b, unknown = checks.r2.r2_classify_operations(
...
def test_r2_classify_counts_unknown_actions_as_class_a_and_names_them():
    ...
    a, b, unknown = checks.r2.r2_classify_operations(_ops(PutObject=1, SomeNewOp=42))
    assert (a, b) == (43, 0)
