...
2. Run `ansible-playbook initial_setup.yml --ask-become-pass`.
3. Run `ansible-playbook deploy.yml --ask-become-pass`.
4. Run `docker exec crowdsec cscli bouncers add bouncer-traefik` and save api key to .env
