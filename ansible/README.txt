...
1. Run `sudo chmod +x /home/ubuntu/setup/install_ansible.sh`.
2. Run `sudo /home/ubuntu/setup/install_ansible.sh`.
3. Run `cp setup/.env .env`.
3. Run `ansible-playbook /home/ubuntu/setup/ansible/playbook.yml`.
