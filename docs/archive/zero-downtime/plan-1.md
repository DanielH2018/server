...
**Spec:** `docs/archive/zero-downtime/design.md`
...
Append the measured result to `docs/archive/zero-downtime/design.md` under a new `## Measured results` heading at the end of the file:
...
- Modify: `docs/archive/zero-downtime/design.md`
...
In `docs/archive/zero-downtime/design.md`, find the line in the *Approach B* section reading:
...
```bash
git add docs/archive/zero-downtime/baseline.md docs/archive/zero-downtime/design.md
