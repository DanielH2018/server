...
| `zero-downtime-deploys-design.md` | the rollout gate shipped; uv run `probe.py health` is the gate it specified | ADR-0012; `scripts/measure_rollout_gap.py` grades the claims | [ADR-0012](../adr/0012-zero-downtime-deploys-gate-on-rollout-and-restarts.md) |
