...
**Prerequisite:** `docs/docs-ui-and-adrs-plan-1.md` must be merged. This plan adds pages and one generator to the site plan 1 builds and serves. It is independent of plan 2 and can land before or after it.
