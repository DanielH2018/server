...
**Spec:** `docs/zero-downtime-deploys-design.md` (slice 1 follow-up)
...
Append to `docs/zero-downtime-baseline.md` under *What the numbers implicate*, noting which of the three gained a probe and confirming each still has endpoints after deploy.

```bash
git add docs/zero-downtime-baseline.md
